...
const Nav = () => {
  ...
  return (
    <nav
     ...
     mt-auto xl:right-4 z-50 xl:top-0 xl:h-auto w-full xl:w-14 xl:max-w-[2.6rem]"
    >
      <div
        ...
        {navData?.map((link, index) => {
          return (
            <Link
              ...
              } relative flex items-center group hover:text-accent transition-all duration-300 capitalize`}
              href={link.path}
              key={index}
            >
